...
st.markdown("""
    ...
    .stTextInput { margin-top: -15px; }import streamlit as st
from datetime import datetime
...
# Pestañas siguientes
with tabs[1]: st.info("Módulo de Arrestado...")
with tabs[2]: st.info("Módulo de Victima...")
with tabs[3]: st.info("Módulo de Testigo...")
with tabs[4]: st.info("Módulo de Consulta...")
    footer {visibility: hidden;}
    #MainMenu {visibility: hidden;}
    header {visibility: hidden;}
    </style>
